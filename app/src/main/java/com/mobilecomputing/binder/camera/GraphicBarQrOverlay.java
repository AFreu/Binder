 ...
 * </ol>
 */
public class GraphicBarQrOverlay<T extends GraphicBarQrOverlay.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link GraphicBarQrOverlay#add(Graphic)}.
     */
    public static abstract class Graphic {
        private GraphicBarQrOverlay mOverlay;

        public Graphic(GraphicBarQrOverlay overlay) {
            mOverlay = overlay;
        }
    ...
    public GraphicBarQrOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
